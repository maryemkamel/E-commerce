...
<main class="login-form" style="padding: 140px 0px 0 0px;">
          ...
          <div class="row g-0">
            ...
            <a href="#"  style="font-size:32px">Deco<span  style="font-size:32px">Shop    
                  ...
                  <div class="form-outline mb-4">
                    <input type="text" id="form2Example17" class="form-control form-control-lg" name="name" placeholder="Name" required autofocus />
                    @if ($errors->has('name'))
                  ...
                  <div class="form-outline mb-4">
                    <input type="text" id="form2Example27" class="form-control form-control-lg"  placeholder="E-mail" name="email" required />
                    @if ($errors->has('email'))
                  ...
                  <p class="mb-5 pb-lg-2" style="color: #393f81;">Already have Account? <a href="{{ route('login') }}"
